...
<body>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                                 修  改 商 品 类 别<small>   Update  Shop Type</small>
                        </h1>
                    </div>
                </div> 
                 <!-- /. ROW  -->
  <form action="Category" method="post">
    <input type="hidden" name="operation" value="5"/>
	    ...
	    <tr>
	      <td>类型id</td><td><input class="form-control"type="text" name="id" value="${categorys.id}"></td>
	    </tr>
	   <%--  <tr>
	    <td>父类id</td><td><input type="text" name="parent_id" value="${categorys.parent_id}"></td>
	    </tr> --%>
	     <tr>
	    <td>类型</td><td><input class="form-control"type="text" name="cname" value="${categorys.cname}"></td>
	    </tr>
	     <tr>
	    <td>商品状态</td><td><input class="form-control"type="text" name="status"  value="${categorys.status}"></td>
	    </tr>
	     <tr>
	    <td>排序方式</td><td><input class="form-control"type="text" name="sort_order" value="${categorys.sort_order}"></td>
	    </tr>
	     <tr>
	    <td>创建时间</td><td><input class="form-control"type="text" name="create_time" value="${categorys.create_time}"></td>
	    </tr>
	    <tr>
	    <td>更新时间</td><td><input class="form-control"type="text" name="update_time" value="${categorys.update_time}"></td>
	    </tr>
	    <tr>
	    <td colspan="2"><input class="btn btn-default" type="submit" value="修改类型" style="width: 280px"></td>
	    </tr>
	    </table>
	   </form>	
