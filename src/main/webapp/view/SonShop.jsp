...
<td>${products.desc}</td>
<td><a style="text-decoration: none; color: green; " href="product?operation=3&id=${products.id}" >删除</a></td>
<td><a href="product?operation=5&id=${products.id}">修改</a></td>
</tr>
</c:forEach>
</table>
</div>
