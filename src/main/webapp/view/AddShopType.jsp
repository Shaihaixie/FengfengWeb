...
<body>
    ...
    <input type="hidden" name="operation" value="4"/>
	    ...
	    <tr>
	    <td>类型id</td><td><input class="form-control" type="text" name="id"></td>
	    </tr>
	     <tr>
	    <td>类型</td><td><input class="form-control" type="text" name="cname"></td>
	    </tr>
	     <tr>
	    <td>商品状态</td><td><input class="form-control"type="text" name="status"></td>
	    </tr>
	     <tr>
	    <td>排序方式</td><td><input class="form-control" type="text" name="sort_order"></td>
	    </tr>
	     <tr>
	    <td>创建时间</td><td><input class="form-control"type="text" name="create_time"></td>
	    </tr>
	    <tr>
	    <td>更新时间</td><td><input  class="form-control"type="text" name="update_time"></td>
	    </tr>
	    <tr>
	    <td colspan="2"><input  class="btn btn-default"type="submit" value="添加类型" style="width: 290px;"></td>
	    </tr>
	    </table>
	   </form>	
