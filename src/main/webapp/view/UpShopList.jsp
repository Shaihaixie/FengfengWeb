			...
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						<h1 class="page-header">
							修 改 商 品<small> Update Shop</small>
						</h1>
					</div>
				</div>
				<!-- /. ROW  -->
				<form action="product" method="post">
					...
					<table align="center">
						...
						<tr>
							<td>商品规格</td>
							<td><input class="form-control" type="text" name="rule"
								value="${products.rule}"></td>
						</tr>
						<tr>
							<td>商品图片</td>
							<td><input class="form-control" type="text" name="pimage"
								value="${products.image}"></td>
						</tr>
						<tr>
							<td>商品库存</td>
							<td><input class="form-control" type="text" name="stock"
								value="${products.stock}"></td>
						</tr>
						<tr>
							<td><input style="position: relative;top:20px" class="btn btn-default" type="submit" value="修改商品"></td>
						</tr>
					</table>
				</form>
