...
<body>
				...
				<div class="row">
					<div class="col-md-12">
						<h1 class="page-header">
							修  改  购 物 车 数 量<small> Update CartNum</small>
						</h1>
					</div>
				</div>
				<!-- /. ROW  -->
    ...
    <input type="hidden" name="operation" value="5"/>
	    <table align="center" >
	    <tr>
	    <td>购物车id</td><td><input class="form-control"type="text" name="id" value="${cart.id}"></td>
	    </tr>
	    <tr>
	    <td>商品id</td><td><input class="form-control" type="text" name="productid" value="${cart.productid}"></td>
	    </tr>
	    <tr>
	    <td>修改购买数目</td><td><input class="form-control" type="text" name="productnum" value="${cart.productNum}"></td>
	    </tr>
	   
	    <tr>
	    <td><input  class="btn btn-default"type="submit" value="修改购物车"></td>
	    </tr>
	    </table>
	   </form>	
