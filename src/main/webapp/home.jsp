  ...
  <li class="active">Data</li>
	...
	<script type="text/javascript">
        ...
        myChart.setOption(option);
				...
				<footer><p>Copyright &copy; 2018.Company name All rights reserved.More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">舟渡</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">山海</a></p>
